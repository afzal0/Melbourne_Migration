# Load data
dominant_data_combined <- readRDS("dominant_data_combined.rds")
dominant_country_data_combined <- readRDS("simplified_dominant_country_data_0.001.rds") #change this as well
raw_bar_chart <- read.csv("raw_bar_chart.csv")
